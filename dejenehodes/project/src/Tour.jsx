...
export default function Tour({ fixed }) {
    return (
      <>
      <NavbarTwo/>
      
      <div className=" text-white px-[20px] lg:px-[100px] bg-no-repeat max-h-[700px] relative min-h-screen   max-w-[1800px] mx-auto w-full grid grid-cols-1 grid-rows-12" style={{ 
      ...
      <>
      <div className="   min-h-[700px]   max-w-[1800px] mx-auto w-full grid grid-cols-1 md:grid-rows-12">
        <div className=" max-sm:mt-[50px]  max-sm:py-[50px] max-sm:px-[20px]  grid sm:grid-cols-12 min-h-full  sm:pl-[130px]  gap-[10px] items-center md:row-span-4">
      ...
      <div className="relative max-h-[700px] mt-[80px] mb-[120px] h-full max-w-[1800px] mx-auto w-full grid md:grid-cols-2">
