...
export default function Art({ fixed }) {
    return (
      <>
      <NavbarTwo/>
      ...
      <div className=" text-white px-[20px] lg:px-[100px]  relative min-h-screen   max-w-[1800px] mx-auto w-full grid grid-cols-1 grid-rows-12" style={{ 
